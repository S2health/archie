 ...
 */
public class S2ValidationHelper {
    private final S2RmInfoLookup lookup;
    private final S2PrimitiveObjectConstraintHelper primitiveObjectConstraintHelper;

    public S2ValidationHelper(S2RmInfoLookup lookup, ValidationConfiguration validationConfiguration) {
        this.lookup = lookup;
        this.primitiveObjectConstraintHelper = new S2PrimitiveObjectConstraintHelper(validationConfiguration);
    }
