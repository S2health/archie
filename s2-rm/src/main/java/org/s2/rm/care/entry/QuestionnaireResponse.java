...
public class QuestionnaireResponse extends Observation {
  ...
  */
  ...
  public QuestionnaireResponse(String questionnaireIdentifier, TerminologyTerm questionnaireTitle, Uuid uid, RmDateTime time, TerminologyCode language, EntityRefNode subject, String archetypeNodeId, String name) {
