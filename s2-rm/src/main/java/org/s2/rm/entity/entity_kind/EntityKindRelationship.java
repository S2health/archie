...
public class EntityKindRelationship extends InfoItem {
  /**
  ...
  */
  ...
  public EntityKindRelationship(ObjectRef source, ObjectRef target, String archetypeNodeId, String name) {
  ...
  public boolean equals(Object other) {
    ...
    return Objects.equals(getCode(), otherAsEntityKindRelationship.getCode()) &&
      Objects.equals(getOriginalCode(), otherAsEntityKindRelationship.getOriginalCode()) &&
      Objects.equals(getLinks(), otherAsEntityKindRelationship.getLinks()) &&
      Objects.equals(uid, otherAsEntityKindRelationship.uid) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), uid, source, target);
  }
