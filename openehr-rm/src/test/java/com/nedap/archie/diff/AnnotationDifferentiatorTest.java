...
public class AnnotationDifferentiatorTest {
    ...
    public void setup() throws Exception {
        flatParent = TestUtil.parseFailOnErrors(this.getClass(),"/com/nedap/archie/diff/openEHR-EHR-OBSERVATION.basic_annotations.v1.0.0.adls");
        child = TestUtil.parseFailOnErrors(this.getClass(),"/com/nedap/archie/diff/openEHR-EHR-OBSERVATION.annotations_specialised_flattened.v1.0.0.adls");
    }
