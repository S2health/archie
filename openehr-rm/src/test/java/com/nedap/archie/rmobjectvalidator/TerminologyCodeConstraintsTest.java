...
public class TerminologyCodeConstraintsTest {
    ...
    public void validationInOptTest() throws Exception {
        ...
        repository.addArchetype(parse("/com/nedap/archie/aom/openEHR-EHR-COMPOSITION.parent.v1.0.0.adls"));
        repository.addArchetype(parse("/com/nedap/archie/aom/openEHR-EHR-GENERIC_ENTRY.included.v1.0.0.adls"));
