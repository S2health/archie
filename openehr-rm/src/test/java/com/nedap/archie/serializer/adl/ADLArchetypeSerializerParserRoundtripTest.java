...
public class ADLArchetypeSerializerParserRoundtripTest {
    ...
    public void basic() throws Exception {
        Archetype basic = loadRoot("com/nedap/archie/basic.adl");
    ...
    public void ckm() throws ADLParseException {
        FullArchetypeRepository ckmRepository = CkmRepositoryBuilder.parseCKM();
    ...
    public void defaultValuesJson() throws Exception {
        testDefaultValues(new OpenEhrRmObjectMapperProvider());
    }
    ...
    private Archetype roundtrip(Archetype archetype) throws ADLParseException {
        return roundtrip(archetype, new OpenEhrRmObjectMapperProvider());
    }
    ...
    private Archetype roundtrip(Archetype archetype, RMObjectMapperProvider rmObjectMapperProvider) throws ADLParseException {
        ...
        ADLParser parser = new ADLParser(AllMetaModelsInitialiser.getMetaModels());
    ...
    private Archetype load(String resourceName) throws IOException, ADLParseException {
        return new ADLParser(AllMetaModelsInitialiser.getMetaModels()).parse(ADLArchetypeSerializerTest.class.getResourceAsStream(resourceName));
    }

    private Archetype loadRoot(String resourceName) throws IOException, ADLParseException {
        return new ADLParser(AllMetaModelsInitialiser.getMetaModels()).parse(ADLArchetypeSerializerTest.class.getClassLoader().getResourceAsStream(resourceName));
    }
